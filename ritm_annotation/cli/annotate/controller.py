...
from ritm_annotation.inference import clicker
from ritm_annotation.inference.predictors import get_predictor
from ritm_annotation.utils.vis import draw_with_blend_and_clicks
    ...
    def set_mask(self, mask):
        if self.image.shape[:2] != mask.shape[:2]:
            messagebox.showwarning(
                _("Warning"),
                _("A segmentation mask must have the same sizes as the current image!"),  # noqa: E501
            )
            return

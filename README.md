...
- 🎯 Entry points to execute your program using `python -m <ritm_annotation>` or `$ ritm_annotation` with basic CLI argument parsing.
...
Awesome ritm_annotation created by lucasew
...
```py
from ritm_annotation import BaseClass
